...
function WindowVSCodeServer({ children, language }: WindowVSCodeProps) {
  return (
    <div className="m-4 rounded-xl overflow-hidden border border-zinc-200 dark:border-zinc-700 shadow-sm">
...
export default function CodeUser({
  ...
  if (!mounted)
    return (
      <WindowVSCodeServer language={language}>{children}</WindowVSCodeServer>
    );
